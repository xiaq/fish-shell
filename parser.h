...
private:
    ...
    */
    ...
    void bad_option(int pos, int type, const wcstring &opt);
    void parse_job_argument_list(process_t *p, job_t *j, tokenizer_t *tok, std::vector<completion_t>&, options_t&, bool);
